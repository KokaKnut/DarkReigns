...
public class PixelPerfectCam : MonoBehaviour
{
    ...
    /**
     * The speed to lerp toward the target
     */
    public float lerpSpeed;
    /**
     * How much do we zoom in. number of pixels across on screen for one pixel
     */
    public int zoom = 1;
    ...
    protected void Start()
    {
        ...
        if (!_camera)
        {
            ...
            targetViewportSizeInPixels = new Vector2(Screen.width /zoom, Screen.height /zoom);
    ...
    public void Update()
    {
        ...
        {
            Vector2 newPosition = new Vector2(Mathf.Lerp(transform.position.x, followTarget.transform.position.x, lerpSpeed * Time.deltaTime), Mathf.Lerp(transform.position.y, followTarget.transform.position.y, lerpSpeed * Time.deltaTime));
